...
### Phase 1: Event Log Generation (`phase1_data_generation.py`)
...
### Phase 2: SQL Funnel & Cohort Queries (`phase2_funnel_cohort.sql`)
...
### Phase 3: RFM Segmentation & A/B Testing (`phase3_rfm_ab_testing.py`)
...
### Phase 4: AI Next-Best-Action Engine (`phase4_ai_action_engine.py`)
...
### Phase 5: Tableau Dashboard Prep (`phase5_tableau_prep.sql`)
...
python phase3_rfm_ab_testing.py
```
